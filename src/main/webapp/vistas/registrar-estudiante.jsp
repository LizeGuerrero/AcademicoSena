...
<body>
    <div class="container">
        ...
        <form id="formEstudiante">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nombreAcudiente" name="nombreAcudiente">
            </div>
            
            <div class="form-row">
                <div class="form-group">
                    <label for="telefonoAcudiente">Teléfono Acudiente</label>
                    <input type="tel" id="telefonoAcudiente" name="telefonoAcudiente">
                </div>
                
                <div class="form-group">
                    <label for="emailAcudiente">Email Acudiente</label>
                    <input type="email" id="emailAcudiente" name="emailAcudiente">
                </div>
            </div>
            
            <div class="btn-group">
                <button type="submit" onclick="registrarEstudiante()">Registrar Estudiante</button>
    ...
    <script>
        function registrarEstudiante() {
            ...
            fetch('/AcademicoSena/api/estudiantes', {
                method: 'POST',
                headers: {
