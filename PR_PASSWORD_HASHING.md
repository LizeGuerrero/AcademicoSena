# Solicitud de Pull (PR): feature/password-hashing
...
## Commits en esta rama (resumen traducido)
- a1ed658: feat(auth): agregar hashing con BCrypt y verificación de contraseñas; hashear al registrar/actualizar
- c9baa7a: chore(config): cargar configuración de BD desde variables de entorno; añadir herramienta de migración y documentación
- 045a829: test(auth): añadir pruebas unitarias completas para PasswordUtils
